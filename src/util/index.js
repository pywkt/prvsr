export { buildLoop } from './buildLoop';
...
//     const withOct = addOctave(partData, oct);
//     const withNoteLen = generateNoteLengths(withOct, noteLensToUse);
//     const withTimeBars = generateTimeBars(withNoteLen, startTime);
//     const trimNotes = trimNotes(withTimeBars, unisonCount);
//     const makeBars = makeBars(trimNotes, maxBars);
//     const looped = makeLoops(makeBars, loopTimes, maxBars)
...
// export * as buildLoop from './buildLoop';
// export * as getRand from './getRand';